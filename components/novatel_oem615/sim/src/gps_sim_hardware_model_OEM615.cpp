...
*/
    ...
    void GPSSimHardwareModelOEM615::get_bestxyza_response(const GPSSimDataPoint& data_point, std::vector<uint8_t>& out_data)
    {
        ...
        Double v_x_i = data_point.get_ECI_vx();
        Double v_y_i = data_point.get_ECI_vy();
        Double v_z_i = data_point.get_ECI_vz();
    ...
    void GPSSimHardwareModelOEM615::get_bestxyzb_response(const GPSSimDataPoint& data_point, std::vector<uint8_t>& out)
    {
        ...
        double_to_uint8vector(data_point.get_ECI_x(), bytes); // P-X_I
        out.insert(out.end(), bytes.begin(), bytes.end());
        bytes.clear();
        double_to_uint8vector(data_point.get_ECI_y(), bytes); // P-Y_I
        out.insert(out.end(), bytes.begin(), bytes.end());
        bytes.clear();
        ...
        double_to_uint8vector(data_point.get_ECI_vx(), bytes); // V-X
        out.insert(out.end(), bytes.begin(), bytes.end());
        bytes.clear();
        double_to_uint8vector(data_point.get_ECI_vy(), bytes); // V-Y
        out.insert(out.end(), bytes.begin(), bytes.end());
        bytes.clear();
        double_to_uint8vector(data_point.get_ECI_vz(), bytes); // V-Z
        out.insert(out.end(), bytes.begin(), bytes.end());
        bytes.clear();
