...
{   
    ...
    switch (CommandCode)
    {
        ...
        // CFE_EVS_SendEvent(NOVATEL_OEM615_DEVICE_TLM_ERR_EID, CFE_EVS_EventType_INFORMATION, 
        //     "NOVATEL_OEM615: received HK command");
            NOVATEL_OEM615_ReportHousekeeping();
            break;

        case NOVATEL_OEM615_REQ_DATA_TLM:
            // CFE_EVS_SendEvent(NOVATEL_OEM615_DEVICE_TLM_ERR_EID, CFE_EVS_EventType_INFORMATION, 
            // "NOVATEL_OEM615: received DATA command");
...
int32 NOVATEL_OEM615_SafeRequestData(NOVATEL_OEM615_Device_Data_tlm_t* data)
{
    ...
    {   
        CFE_EVS_SendEvent(NOVATEL_OEM615_DEVICE_TLM_ERR_EID, CFE_EVS_EventType_INFORMATION, 
                "NOVATEL_OEM615: about to call requestdata");
