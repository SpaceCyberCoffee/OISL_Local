...
//    double temp_sside[3] = {0.0, 0.0, 0.0};
   ...
   double err_secondary[3] = {0.0, 0.0, 0.0};
    ...
    // Write to file the error trend to analize how it changes.
    char *filename_E = "/home/jstar/Desktop/github-nos3/sims/build/bin/ERRORS.txt";
    FILE *fp_E = fopen(filename_E, "w");
    fprintf(fp_E, "%f %f %f", ACS->therr[0], ACS->therr[1], ACS->therr[2]);
    fclose(fp_E);
