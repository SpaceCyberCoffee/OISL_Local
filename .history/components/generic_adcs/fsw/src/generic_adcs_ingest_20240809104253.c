...
void Generic_ADCS_ingest_generic_OISL(CFE_MSG_Message_t * Msg, Generic_ADCS_DI_OISL_Tlm_Payload_t *OISL)
{
    ...
    double OISL_vector_ECI[3] = {oisl->Oisl.BFWARD_ISL_X, oisl->Oisl.BACKWARD_ISL_Y, oisl->Oisl.BACKWARD_ISL_Z};    // SHOULD BE SIMILAR TO VELOCITY UNITY VECTOR since it is backward-central so direction of the forward.
