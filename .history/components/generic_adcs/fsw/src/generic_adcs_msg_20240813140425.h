...
typedef struct
{
    ...
    Generic_ADCS_DI_OISL_Tlm_Payload_t  OISL;
...
typedef struct
{
    ...
    Generic_ADCS_AD_ISL_Tlm_Payload_t Isl;
...
typedef struct {
   ...
   double Tcmd[3];
   double err_t;
} __attribute__((packed)) Generic_ADCS_AC_OISL_Tlm_t;

typedef struct {
    Generic_ADCS_AC_Bdot_Tlm_t    Bdot;
    Generic_ADCS_AC_Sunsafe_Tlm_t Sunsafe;
    Generic_ADCS_AC_OISL_Tlm_t OISL;
