    ...
    Generic_ADCS_GNC_Tlm_Payload_t *GNC, Generic_ADCS_AC_Tlm_Payload_t *ACS)
{
    ...
    &ACS->OISL.sside_B[0], &ACS->OISL.sside_B[1], &ACS->OISL.sside_B[2], &ACS->OISL.nadir[0], &ACS->OISL.nadir[1], &ACS->OISL.nadir[2], &ACS->OISL.vmax, 
...
static void AC_oisl(Generic_ADCS_GNC_Tlm_Payload_t *GNC, Generic_ADCS_AC_OISL_Tlm_t *ACS, const char *F_or_B)
{
   ...
   // Calculate the scalar product between SUN vector and nadir vector
   double SoS_nadir = VoV(selected_ISL_vector, ACS->nadir);
