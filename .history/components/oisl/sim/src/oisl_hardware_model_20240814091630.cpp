...
namespace Nos3
{
    ...
    void OislHardwareModel::create_oisl_data(std::vector<uint8_t>& out_data)
    {
        ...
        */
        ...
        sim_logger->debug("OislHardwareModel::create_oisl_data  ALIGNED: =  %u, %u. VoV values for foward and backward: %f %f %f", forward_alignment,  backward_alignment, VoV_F, VoV_B, cos(FoR));
