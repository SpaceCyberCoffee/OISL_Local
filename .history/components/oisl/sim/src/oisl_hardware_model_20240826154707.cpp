...
namespace Nos3
{
    ...
    void OislHardwareModel::create_oisl_data(std::vector<uint8_t>& out_data)
    {
        ...
        */
        ...
        const char *filenametest = "/home/jstar/Desktop/github-nos3/sims/build/bin/forward_stability_2vectors.txt";

        FILE *file_ISL_change = fopen("/home/jstar/Desktop/github-nos3/sims/build/bin/VoV_BACKWARD.txt", "r");
        double ISL_change_percentage = 0.0;  // Default value
        if (file_ISL_change != NULL) {
            fscanf(file_ISL_change "%lf", &ISL_change_percentage);
            fclose(file_ISL_change);
        }
        // open the file for writing
        FILE *fp3 = fopen(filenametest, "a");
        // write to the text file
        fprintf(fp3, "%u %f %f\n", forward_alignment, VoV_F, ISL_change_percentage);
        // close the file
        fclose(fp3);   
