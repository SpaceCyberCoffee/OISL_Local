        ...
        */
        ...
        case OISL_SEND_FILE:
            ...
            {   
                ...
                OISL_AppData.GNCPacket.Payload.Mode = cmd->Mode; // Keep the current value in **one** place
                CFE_EVS_SendEvent(OISL_CMD_SEND_FILE_EID, CFE_EVS_EventType_INFORMATION, "OISL: Transfer File command received");
                OISL_SendFile_CFDP();
            }
            break;
