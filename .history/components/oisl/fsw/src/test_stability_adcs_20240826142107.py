...
def plot_data(data):
    ...
    plt.legend()
    # plt.show()
    plt.savefig("/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/EPSmodified.png")

if __name__ == "__main__":
    file_path = '/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/forward_stability_EPSMODIFIED.txt'  # Path to your data file
