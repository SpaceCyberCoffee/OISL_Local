...
void sendFile(const char *fileContent, const size_t fileSize) {
    ...
    /* If each PDU can carry 504 bytes of data and you can send a maximum of 1000 PDUs, the maximum file size in bytes is: Max File Size (bytes)=504×1000=504000 bytes = 504 */
