...
void get_isl_vectors(double* forward_ISL_vector, double* backward_ISL_vector)
{
    ...
    OS_printf("DIstanza tra satelliti in KM: %f", sqrt(ISL_vector_forward[0]*ISL_vector_forward[0]+ISL_vector_forward[1]*ISL_vector_forward[1]+ISL_vector_forward[2]*ISL_vector_forward[2])); // 1
