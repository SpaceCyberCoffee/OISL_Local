...
def plot_data(data):
    ...
    plt.figure(figsize=(10, 5))
    plt.plot([dat for dat in data[0:, 1] if dat>0.989], label='Second Column')
    ...
    plt.legend()
    # plt.show()
    plt.savefig("/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/2Vectors_PT2.png")

if __name__ == "__main__":
    file_path = '/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/forward_stability_2vectors_PT2.txt'  # Path to your data file
