    ...
    with open(file1, 'r') as f1, open(file2, 'r') as f2:
        for i, (line1, line2) in enumerate(zip(f1, f2)):
            ...
            if i % 2 == 0:
                ...
                coords1 = line1.split()
                forw_42.append(float(coords1[0]))
...
if __name__ == "__main__":
    ...
    plt.plot([i + 231 for i in range(len(forward_PROP))], forward_PROP, label='Propagated SAT')

    # Set up the axes
    plt.xlabel('Raw Number')
    plt.ylabel('Coordinate Value')
    plt.title('Comparison of 42 SAT and Forward SAT Coordinates')
