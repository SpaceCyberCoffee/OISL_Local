...
int32_t OISL_RequestData(uart_info_t* device, OISL_Device_Data_tlm_t* data)
{
    ...
    const char* alignment_info_forward = "/home/jstar/Desktop/github-nos3/components/oisl/fsw/src/F_sat_for_alignment.txt";
    ...
    data->ForwardConnection = read_alignment_info(alignment_info_backward);
