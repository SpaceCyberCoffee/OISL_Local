...
int32_t OISL_RequestData(uart_info_t* device, OISL_Device_Data_tlm_t* data)
{
    ...
    // read the value in the file, which is 1 or 0. if the file is there and the info is 1, then forward connection =1. else, maning if the filke does not exist or the info is 0, then 
