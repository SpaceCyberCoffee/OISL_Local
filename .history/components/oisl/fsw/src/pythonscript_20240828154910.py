    ...
    with open(file1, 'r') as f1, open(file2, 'r') as f2:
        for i, (line1, line2) in enumerate(zip(f1, f2)):
            ...
            if i % 3 == 0:
                ...
                coords1 = map(float, line1.split())
                coords2 = map(float, line2.split())
...
if __name__ == "__main__":
    # File names
    file1 = '/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/central_sat.txt'
    file2 = '/mnt/extras/SSD/NOS3_RBT/nos3_luca_OISL/nos3_rbt/components/oisl/fsw/src/forward_sat.txt'
    ...
    plt.plot(range(len(forward_sat)), forward_sat, label='Forward SAT')
