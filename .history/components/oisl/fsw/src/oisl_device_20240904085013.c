...
void get_isl_vectors(double* forward_ISL_vector, double* backward_ISL_vector)
{
    ...
    FILE *fpd = fopen("/home/jstar/Desktop/github-nos3/components/oisl/fsw/src/FORWARD_position_PROPAGATED.txt", "a");
    if (fpd == NULL)
    {
    ...
    fprintf(fpd, "%f %f %f\n", forward_satellite[0], forward_satellite[1], ECI_vector[2]);
