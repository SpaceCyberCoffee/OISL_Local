    ...
    void Generic_star_trackerDataPoint::do_parsing(void) const
    {
        try {
            ...
            */
            ...
            /* Debug print */
            sim_logger->tr("Generic_star_trackerDataPoint::Generic_star_trackerDataPoint:  Parsed qn = %f %f %f %f", _generic_star_tracker_data[0], _generic_star_tracker_data[1], _generic_star_tracker_data[2], _generic_star_tracker_data[3]);
