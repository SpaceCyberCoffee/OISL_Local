...
void CI_Lab_AppMain(void)
{
    ...
    */
    while (CFE_ES_RunLoop(&RunStatus) == true)
    {
        ...
        OS_printf("WIthin CI LAB APP MAIN MAIN LOOP\n");
        ...
        // {   OS_printf("About to call ReadUpLInk\n");
            CI_LAB_ReadUpLink();
        }
    }
...
void CI_LAB_TaskInit(void)
{
    ...
    */
    ...
    OS_printf("Maybe initialize here?\n");
...
void CI_LAB_ReadUpLink(void)
{
    ...
    for (i = 0; i <= 10; i++)
    {
        ...
        if (status >= (int32)sizeof(CFE_MSG_CommandHeader_t) && status <= ((int32)CI_LAB_MAX_INGEST))
        {
            ...
            OS_printf("About to call SB transmit buffer");
